...
<div class="container mx-auto px-4 pt-16">
    <div class="popular-movies">
        <h2 class="uppercase tracking-wider text-orange-500 text-lg font-semibold">Popular TV Show</h2>
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
                ...
                <div class="grid grid-col-4 gap-16 ">
                    <div class="mt-8">
                        ...
                        <div class=" text-lg mt-2 hover:text-gray-300 "><a href="{{ route('tvshow.show', $tvshow['id']) }}">{{$tvshow['name']}}</a>
